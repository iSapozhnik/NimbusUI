...
public class Scroller: NSScroller {
    ...
    public var knobCornerRadius: CGFloat = 2
    public var knobInsetVertical: CGFloat = 6
    public var knobInsetHorizontal: CGFloat = 3
    public var slotCornerRadius: CGFloat = 5
    public var slotInset: CGFloat = 3
